...
public class ClientForgeEvents {
    ...
    public static void onItemTooltip(ItemTooltipEvent event) {
        ...
        if (item instanceof EfficiencyAddonItem) {
            ...
            event.getToolTip().add(new TranslatableComponent(new TranslatableComponent("item.mifa.cooldown_amount").getString() + ": "  + reduction + "%").withStyle(ChatFormatting.GRAY));
            ...
            event.getToolTip().add(new TranslatableComponent(new TranslatableComponent("item.industrialforegoing.processing").getString().replace(" ", "") + ": x" + upgrade).withStyle(ChatFormatting.GRAY));
            ...
            event.getToolTip().add(new TranslatableComponent(new TranslatableComponent("item.mifa.cooldown_time").getString() + ": "  + String.valueOf(reduction).substring(0, 3) + "%").withStyle(ChatFormatting.GRAY));
        }
    }
